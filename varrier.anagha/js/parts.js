const makeThoughtList = templater(o=> `
	<li>
		<div href="#thought-profile-page" style="display: flex; position: relative;" class="thought-jump" data-id="${o.id}">
			<img src="${o.img}">
			<div class="list-item-text">
				<h3>Thought: <span>${o.thought}</span></h3>
...
const ThoughtProPage = templater(o=> `
	...
	<div class="down-section">
		<div class="overscroll">
			...
			<div class="card display-number"><p>Make: ${o.thought}</p></div>
